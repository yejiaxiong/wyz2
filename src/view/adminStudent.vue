<template>
  <div>
    ...
    >
      ...
      <el-table-column prop='studentNumber' label='学号' sortable width='110'>
      </el-table-column>
      <el-table-column prop='studentName' label='姓名' width='90'> </el-table-column>
      <el-table-column prop='studentClass' label='班级' width='90'>
      </el-table-column>
      ...
      <el-table-column align='center'>
        <template slot-scope='scope'>
          ...
          <el-button type='warning' size="small" @click='modStu(scope.row)'>修改</el-button>
        </template>
      </el-table-column>
    </el-table><br>
<el-row >
...
export default {
  ...
  methods: {
    ...
    deleteRow(index, rows) {
      this.$confirm('此操作将永久删除该学生信息, 是否继续?', '提示', {
        ...
        this.$http({method: "POST",
          url: this.$http.defaults.baseURL+'deleteStudent',
    ...
    // 修改学生信息 获取当前行存于sessionStorge 并跳转到modStudent
    modStu(rows) {
      // console.log(rows);
