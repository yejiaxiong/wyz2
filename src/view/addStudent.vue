<template>
  <div>
    ...
    <el-form
      ...
      class='demo-ruleForm'>
      <el-row :gutter='20'>
        <el-col :xs='{span:8,offset:1}' :md='{span:12,offset:5}'>
          <div>
      ...
      <el-row :gutter='20'>
        <el-col :xs='{span:2,offset:2}' :md='{span:6,offset:7}'>
          <div class='grid-content bg-purple'>
            <el-button type='success' @click="submitForm('ruleForm')">立即提交</el-button>
          </div>
        </el-col>
        <el-col :xs='{span:2,offset:4}' :md='{span:6,offset:2}'>
          <div class='grid-content bg-purple'>
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          this.$http({method: "POST",
            url: this.$http.defaults.baseURL+'insertStudent',
            headers: {'Content-type': 'application/json;charset=UTF-8'},
            data: JSON.stringify(this.ruleForm)});
          window.sessionStorage.setItem('activepath','/adminstudent')
