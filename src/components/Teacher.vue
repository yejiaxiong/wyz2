  ...
  <el-container>
    ...
    <el-container>
      ...
      <el-aside width="200px" style='background-color:#eeeeee'>
        <!-- menu -->
        <el-menu text-color="#000" router background-color="#eeeeee" :default-active="activepath" unique-opened>
          <el-submenu index="">
            <template slot="title">
            ...
            <el-menu-item-group>
              <el-menu-item v-for="(value,index) in classlist" :index="'/classluru'+(index+1)" @click="saveClassNumber(value)">{{value}}</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
...
export default {
  ...
  created () {
    this.classlist = window.sessionStorage.getItem('classid').split(",");
    this.classlist = this.classlist.slice(0,3);
